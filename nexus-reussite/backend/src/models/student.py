...
class Student(db.Model):
    ...
    cognitive_profile = db.Column(db.Text, nullable=True)  # JSON string avec les préférences
...
class Assessment(db.Model):
    ...
    detailed_results = db.Column(db.Text, nullable=True)  # JSON string avec analyse détaillée
