...
class VideoConferenceService:
    ...
    def join_conference(self, room_id: str, user_id: str, user_name: str, user_email: str,
        ...
        if room_id not in self.active_rooms:
            return {
                'success': False,
                'error': 'Salle de conférence non trouvée'
            }
        ...
        if len(room.participants) >= room.max_participants:
            return {
                'success': False,
                'error': 'Salle de conférence pleine'
            }
    ...
    def leave_conference(self, room_id: str, user_id: str) -> Dict[str, Any]:
        ...
        if not participant:
            return {
                'success': False,
                'error': 'Participant non trouvé dans la salle'
            }
        ...
        return {
            'success': True,
            'message': 'Participant retiré de la conférence'
        }
    ...
    def get_student_rooms(self, student_id: str) -> List[Dict[str, Any]]:
        ...
        # TODO: Implémenter la logique d'inscription aux cours
        for room in self.active_rooms.values():
