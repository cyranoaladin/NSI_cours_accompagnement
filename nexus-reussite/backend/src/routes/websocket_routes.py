...
def notify_student_progress():
    ...
    try:
        ...
        # TODO: Récupérer l'ID du parent depuis la base de données
        parent_id = f"parent_{student_id}"  # Exemple
        parent_notification = create_parent_notification(
            parent_id,
            "Votre enfant",  # TODO: Récupérer le vrai nom
        ...
        return jsonify({
            'success': success,
            'message': 'Notification de progression envoyée'
        })
...
def notify_achievement():
    ...
    try:
        ...
        return jsonify({
            'success': success,
            'message': 'Notification de réussite envoyée'
        })
...
def send_teacher_message():
    ...
    try:
        ...
        return jsonify({
            'success': success,
            'message': 'Message envoyé à l\'élève'
        })
