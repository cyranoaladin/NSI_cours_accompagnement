...
class EventDispatcherInterface(ABC):
    """Represents a dispatcher that dispatches events to listeners associated with given
    event."""
...
class AfterSingleConnectionInstantiationEvent:
    ...
    :param connection_lock: For sync client thread-lock should be provided, for async
        asyncio.Lock
    """
...
class AfterAsyncClusterInstantiationEvent:
    ...
    Async cluster doesn't use connection pools, instead ClusterNode object manages
    connections.
    """
