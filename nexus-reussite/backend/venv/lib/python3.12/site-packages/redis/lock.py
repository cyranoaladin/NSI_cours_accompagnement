...
class Lock:
    """A shared, distributed Lock. across processes and/or machines. Using. Redis for
    locking allows the Lock. to be shared.

    It's left to the user to resolve deadlock issues and make sure multiple clients play
    nicely together.
    """
    ...
    def __init__(
        ...
        """Create a new Lock instance named ``name`` using the Redis client supplied by
        ``redis``.
    ...
    def acquire(
        ...
        """Use Redis to hold a shared, distributed lock named ``name``. acquired.
        Returns True. once the lock is.
