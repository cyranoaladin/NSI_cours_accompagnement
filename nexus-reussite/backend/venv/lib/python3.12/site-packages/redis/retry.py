...
class Retry:
    ...
    def __init__(
        ...
        """Initialize a `Retry` object with a `Backoff` object that retries a maximum of
        `retries` times.
    ...
    def call_with_retry(
        ...
        """Execute an operation that might fail and returns its result, or raise the
        exception that was thrown depending on the `Backoff` object.
