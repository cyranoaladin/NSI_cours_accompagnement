...
class StreamingCredentialProvider(CredentialProvider, ABC):
    ...
    def on_next(self, callback: Callable[[Any], None]):
        """Specifies the callback that should be invoked when the next credentials will
        be retrieved.
...
class UsernamePasswordCredentialProvider(CredentialProvider):
    """Simple implementation of CredentialProvider that just wraps static username and
    password."""
