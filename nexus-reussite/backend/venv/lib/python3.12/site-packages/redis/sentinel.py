...
class Sentinel(SentinelCommands):
    ...
    def discover_master(self, service_name):
        """Asks sentinel servers for the Redis master's address corresponding to the
        service labeled ``service_name``.

        Returns a pair (address, port) or raises MasterNotFoundError if no master is
        found.
        """
    ...
    def master_for(
        ...
        **kwargs,
        ...
        """Returns a redis client instance for the ``service_name`` master. detect
        failover and reconnect Redis clients automatically. Sentinel. client will.
