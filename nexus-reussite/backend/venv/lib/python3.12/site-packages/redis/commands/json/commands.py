...
class JSONCommands:
    ...
    def arrappend(
        ...
        `JSON.ARRAPPEND <https://redis.io/commands/json.arrappend>`_..
        """  # noqa
    ...
    def arrinsert(
        ...
        """Insert the objects ``args`` to the array at index ``index`` under the ``path`
        in key ``name``.

        For more information see
        `JSON.ARRINSERT <https://redis.io/commands/json.arrinsert>`_.
        """  # noqa
    ...
    def arrlen(
        ...
        For more information see
        `JSON.ARRLEN <https://redis.io/commands/json.arrlen>`_.
        """  # noqa
    ...
    def arrpop(
        ...
        """Pop the element at ``index`` in the array JSON value under ``path`` at key
        ``name``.

        For more information see
        `JSON.ARRPOP <https://redis.io/commands/json.arrpop>`_.
        """  # noqa
    ...
    def arrtrim(
        ...
        """Trim the array JSON value under ``path`` at key ``name`` to the inclusive
        range given by ``start`` and ``stop``.

        For more information see
        `JSON.ARRTRIM <https://redis.io/commands/json.arrtrim>`_.
        """  # noqa
    ...
    def type(self, name: str, path: Optional[str] = Path.root_path()) -> List[str]:
        ...
        For more information see
        `JSON.TYPE <https://redis.io/commands/json.type>`_.
        """  # noqa
    ...
    def resp(self, name: str, path: Optional[str] = Path.root_path()) -> List:
        ...
        For more information see
        `JSON.RESP <https://redis.io/commands/json.resp>`_.
        """  # noqa
    ...
    def objkeys(
        ...
        """Return the key names in the dictionary JSON value under ``path`` at key
        ``name``.

        For more information see
        `JSON.OBJKEYS <https://redis.io/commands/json.objkeys>`_.
        """  # noqa
    ...
    def objlen(
        ...
        For more information see
        `JSON.OBJLEN <https://redis.io/commands/json.objlen>`_.
        """  # noqa
        return self.execute_command("JSON.OBJLEN", name, str(path), keys=[name])

    def numincrby(self, name: str, path: str, number: int) -> str:
        """Increment the numeric (integer or floating point) JSON value under ``path``
        at key ``name`` by the provided ``number``.

        For more information see
        `JSON.NUMINCRBY <https://redis.io/commands/json.numincrby>`_.
        """  # noqa
    ...
    def nummultby(self, name: str, path: str, number: int) -> str:
        """Multiply the numeric (integer or floating point) JSON value under ``path`` at
        key ``name`` with the provided ``number``.

        For more information see
        `JSON.NUMMULTBY <https://redis.io/commands/json.nummultby>`_.
        """  # noqa
        return self.execute_command(
    ...
    def clear(self, name: str, path: Optional[str] = Path.root_path()) -> int:
        ...
        For more information see
        `JSON.CLEAR <https://redis.io/commands/json.clear>`_.
        """  # noqa
    ...
    def delete(self, key: str, path: Optional[str] = Path.root_path()) -> int:
        ...
        For more information see
        `JSON.DEL <https://redis.io/commands/json.del>`_.
        """
    ...
    def mget(self, keys: List[str], path: str) -> List[JsonType]:
        """Get the objects stored as a JSON values under ``path``. is a list of one or.
        more keys. ``keys``

        For more information see
        `JSON.MGET <https://redis.io/commands/json.mget>`_.
        """  # noqa
        pieces = []
        pieces += keys
    ...
    def mset(self, triplets: List[Tuple[str, str, JsonType]]) -> Optional[str]:
        """Set the JSON value at key ``name`` under the ``path`` to ``obj`` for one or
        more keys.
    ...
    def merge(
        ...
        """Merges a given JSON value into matching paths. children Consequently, JSON
        values. at matching paths are updated, deleted, or expanded with new.
    ...
    def set_file(
        ...
        """Set the JSON value at key ``name`` under the ``path`` to the content of the
        json file ``file_name``.
    ...
    def set_path(
        ...
        """Iterate over ``root_folder`` and set each JSON file to a value under
        ``json_path`` with the file name as the key.
    ...
    def strlen(self, name: str, path: Optional[str] = None) -> List[Optional[int]]:
        ...
        For more information see
        `JSON.STRLEN <https://redis.io/commands/json.strlen>`_.
        """  # noqa
        pieces = [name]
        if path is not None:
            pieces.append(str(path))
    ...
    def toggle(
        ...
        returning the new value.         For more information see
        `JSON.TOGGLE <https://redis.io/commands/json.toggle>`_.
        """  # noqa
    ...
    def strappend(
        ...
        """Append to the string JSON value. specified after option is passed, then the
        key name, the path is determined to the first. If a single If two options are be
        the root_path (i.e Path.root_path()) is used.

        For more information see
        `JSON.STRAPPEND <https://redis.io/commands/json.strappend>`_.
        """  # noqa
    ...
    def debug(
        ...
        For more information see
        `JSON.DEBUG <https://redis.io/commands/json.debug>`_.
        """  # noqa
