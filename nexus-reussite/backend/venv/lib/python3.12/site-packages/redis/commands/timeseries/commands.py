...
class TimeSeriesCommands:
    ...
    def add(
        ...
        """Append a sample to a time series. created. When the specified. key does not
        exist, a new. time series is.
    ...
    def incrby(
        ...
        """Increment the latest sample's of a series. does not. exist, a new time series
        is. created. When the specified key.
    ...
    def decrby(
        ...
        """Decrement the latest sample's of a series. does not. exist, a new time series
        is. created. When the specified key.
