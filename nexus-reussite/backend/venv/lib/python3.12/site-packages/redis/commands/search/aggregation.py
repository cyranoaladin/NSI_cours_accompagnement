...
class AggregateRequest:
    ...
    def __init__(self, query: str = "*") -> None:
        """Create an aggregation request. may then be. passed to. `client.aggregate()`.
        This request.
    ...
    def load(self, *fields: List[str]) -> "AggregateRequest":
        """Indicate the fields to be returned in the response. specified. These fields
        are. returned in addition to. any others implicitly.
    ...
    def sort_by(self, *fields: List[str], **kwargs) -> "AggregateRequest":
        """Indicate how the results should be sorted. queries This can. also be used
        for. *top-N* style.
    ...
    def filter(self, expressions: Union[str, List[str]]) -> "AggregateRequest":
        """Specify filter for post-query results using predicates relating to values in
        the result set.
    ...
    def with_schema(self) -> "AggregateRequest":
        """If set, the `schema` property will contain a list of `[field, type]` entries
