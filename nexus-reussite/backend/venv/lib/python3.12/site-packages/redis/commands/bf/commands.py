...
class BFCommands:
    ...
    def create(self, key, errorRate, capacity, expansion=None, noScale=None):
        ...
        Default expansion value is 2. By default, filter is auto-scaling. For more
        information see
        `BF.RESERVE <https://redis.io/commands/bf.reserve>`_.
        """  # noqa
    ...
    def exists(self, key, item):
        ...
        `BF.EXISTS <https://redis.io/commands/bf.exists>`_.
        """  # noqa
    ...
    def mexists(self, key, *items):
        ...
        For more information see
        `BF.MEXISTS <https://redis.io/commands/bf.mexists>`_.
        """  # noqa
    ...
    def loadchunk(self, key, iter, data):
        ...
        See the SCANDUMP command for example usage. This command will overwrite any
        bloom filter stored under key. Ensure that the bloom filter will not be modified
        between invocations. For more information see
        `BF.LOADCHUNK <https://redis.io/commands/bf.loadchunk>`_.
        """  # noqa
        return self.execute_command(BF_LOADCHUNK, key, iter, data)

    def info(self, key):
        """Return capacity, size, number of filters, number of items inserted, and
        expansion rate.
...
class CFCommands:
    ...
    def create(
        ...
        For more information see
        `CF.RESERVE <https://redis.io/commands/cf.reserve>`_.
        """  # noqa
        params = [key, capacity]
        self.append_expansion(params, expansion)
    ...
    def insert(self, key, items, capacity=None, nocreate=None):
        """Add multiple `items` to a Cuckoo Filter `key`, allowing the filter to be
    ...
    def insertnx(self, key, items, capacity=None, nocreate=None):
        ...
        allowing the filter to be created with a custom `capacity` if it does not yet
        exist.
    ...
    def exists(self, key, item):
        ...
        For more information see
        `CF.EXISTS <https://redis.io/commands/cf.exists>`_.
        """  # noqa
    ...
    def mexists(self, key, *items):
        ...
        For more information see
        `CF.MEXISTS <https://redis.io/commands/cf.mexists>`_.
        """  # noqa
    ...
    def count(self, key, item):
        ...
        For more information see
        `CF.COUNT <https://redis.io/commands/cf.count>`_.
        """  # noqa
    ...
    def loadchunk(self, key, iter, data):
        ...
        See the SCANDUMP command for example usage.         This command will overwrite
        any Cuckoo filter stored under key.         Ensure that the Cuckoo filter will
        not be modified between invocations.         For more information see
        `CF.LOADCHUNK <https://redis.io/commands/cf.loadchunk>`_.
        """  # noqa
...
class TOPKCommands:
    ...
    def reserve(self, key, k, width, depth, decay):
        """Create a new Top-K Filter `key` with desired probability of false positives
        `errorRate` expected entries to be inserted as `size`.

        For more information see
        `TOPK.RESERVE <https://redis.io/commands/topk.reserve>`_.
        """  # noqa
    ...
    def add(self, key, *items):
        ...
        For more information see
        `TOPK.ADD <https://redis.io/commands/topk.add>`_.
        """  # noqa
    ...
    def query(self, key, *items):
        ...
        For more information see
        `TOPK.QUERY <https://redis.io/commands/topk.query>`_.
        """  # noqa
    ...
    def count(self, key, *items):
        ...
        For more information see
        `TOPK.COUNT <https://redis.io/commands/topk.count>`_.
        """  # noqa
    ...
    def info(self, key):
        ...
        For more information see
        `TOPK.INFO <https://redis.io/commands/topk.info>`_.
        """  # noqa
...
class TDigestCommands:
    def create(self, key, compression=100):
        ...
        For more information see
        `TDIGEST.CREATE <https://redis.io/commands/tdigest.create>`_.
        """  # noqa
    ...
    def add(self, key, values):
        ...
        For more information see
        `TDIGEST.ADD <https://redis.io/commands/tdigest.add>`_.
        """  # noqa
    ...
    def merge(self, destination_key, num_keys, *keys, compression=None, override=False):
        """Merges all of the values from `keys` to 'destination-key' sketch. to provide
        the `num_keys` before passing the input keys and the other It is mandatory
        (optional) arguments. If `destination_key` already exists its values are merged
        with the input keys. If you wish to override the destination key contents use
        the `OVERRIDE` parameter.

        For more information see
        `TDIGEST.MERGE <https://redis.io/commands/tdigest.merge>`_.
        """  # noqa
    ...
    def min(self, key):
        """Return minimum value from the sketch `key`.

        Will return DBL_MAX if the sketch is empty. For more information see
        `TDIGEST.MIN <https://redis.io/commands/tdigest.min>`_.
        """  # noqa
        return self.execute_command(TDIGEST_MIN, key)

    def max(self, key):
        """Return maximum value from the sketch `key`.

        Will return DBL_MIN if the sketch is empty. For more information see
        `TDIGEST.MAX <https://redis.io/commands/tdigest.max>`_.
        """  # noqa
    ...
    def quantile(self, key, quantile, *quantiles):
        ...
        the observations added to this t-digest would be less than or equal to each of
        the specified cutoffs.

        (Multiple quantiles can be returned with one call) For more information see
        `TDIGEST.QUANTILE <https://redis.io/commands/tdigest.quantile>`_.
        """  # noqa
    ...
    def cdf(self, key, value, *values):
        ...
        For more information see
        `TDIGEST.CDF <https://redis.io/commands/tdigest.cdf>`_.
        """  # noqa
        return self.execute_command(TDIGEST_CDF, key, value, *values)

    def info(self, key):
        """Return Compression, Capacity, Merged Nodes, Unmerged Nodes, Merged Weight,
        Unmerged Weight and Total Compressions.

        For more information see
        `TDIGEST.INFO <https://redis.io/commands/tdigest.info>`_.
        """  # noqa
        return self.execute_command(TDIGEST_INFO, key)

    def trimmed_mean(self, key, low_cut_quantile, high_cut_quantile):
        """Return mean value from the sketch, excluding observation values outside the
        low and high cutoff quantiles.

        For more information see
        `TDIGEST.TRIMMED_MEAN <https://redis.io/commands/tdigest.trimmed_mean>`_.
        """  # noqa
    ...
    def rank(self, key, value, *values):
        """Retrieve the estimated rank of value (the number of observations in the
        sketch that are smaller than value + half the number of observations that are
        equal to value).

        For more information see
        `TDIGEST.RANK <https://redis.io/commands/tdigest.rank>`_.
        """  # noqa
        return self.execute_command(TDIGEST_RANK, key, value, *values)

    def revrank(self, key, value, *values):
        """Retrieve the estimated rank of value (the number of observations in the
        sketch that are larger than value + half the number of observations that are
        equal to value).

        For more information see
        `TDIGEST.REVRANK <https://redis.io/commands/tdigest.revrank>`_.
        """  # noqa
    ...
    def byrank(self, key, rank, *ranks):
        ...
        For more information see
        `TDIGEST.BY_RANK <https://redis.io/commands/tdigest.by_rank>`_.
        """  # noqa
    ...
    def byrevrank(self, key, rank, *ranks):
        ...
        For more information see
        `TDIGEST.BY_REVRANK <https://redis.io/commands/tdigest.by_revrank>`_.
        """  # noqa
...
class CMSCommands:
    ...
    def initbydim(self, key, width, depth):
        """Initialize a Count-Min Sketch `key` to dimensions (`width`, `depth`)
        specified by user.

        For more information see
        `CMS.INITBYDIM <https://redis.io/commands/cms.initbydim>`_.
        """  # noqa
        return self.execute_command(CMS_INITBYDIM, key, width, depth)

    def initbyprob(self, key, error, probability):
        """Initialize a Count-Min Sketch `key` to characteristics (`error`,
        `probability`) specified by user.

        For more information see
        `CMS.INITBYPROB <https://redis.io/commands/cms.initbyprob>`_.
        """  # noqa
    ...
    def query(self, key, *items):
        """Return count for an `item` from `key`.

        Multiple items can be queried with one call. For more information see
        `CMS.QUERY <https://redis.io/commands/cms.query>`_.
        """  # noqa
        return self.execute_command(CMS_QUERY, key, *items)

    def merge(self, destKey, numKeys, srcKeys, weights=[]):
        """Merge `numKeys` of sketches into `destKey`.

        Sketches specified in `srcKeys`.
    ...
    def info(self, key):
        ...
        For more information see
        `CMS.INFO <https://redis.io/commands/cms.info>`_.
        """  # noqa
