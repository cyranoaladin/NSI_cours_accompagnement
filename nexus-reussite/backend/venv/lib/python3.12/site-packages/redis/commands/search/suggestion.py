...
class Suggestion:
    """Represents a single suggestion being sent or returned from the autocomplete
    server."""
...
class SuggestionParser:
    ...
    This needs to consume either 1, 2, or 3 values at a time from the return value
    depending on what objects were requested
    """
