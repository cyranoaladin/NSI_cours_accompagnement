...
class Value:
    ...
    def combinable(self):
        ...
        This makes the filter potentially more efficient
        """
        return False
...
class IntersectNode(Node):
    ...
    All children need to be satisfied in order for this node to evaluate as true
    """
...
class UnionNode(Node):
    ...
    Any of the children need to be satisfied in order for this node to evaluate as true
    """
...
class DisjunctNode(IntersectNode):
    ...
    In order for this node to be true, all of its children must evaluate to false
    """
...
class OptionalNode(IntersectNode):
    ...
    If this nodes evaluates to true, then the document will be rated higher in
    score/rank.
    """
