...
class ImageFormatter(Formatter):
    """Create a PNG image from source code. a pixmap from the source code. This. uses
    the Python Imaging Library to. generate.
    ...
    def format(self, tokensource, outfile):
        """Format ``tokensource``, an iterable of ``(tokentype, tokenstring)`` tuples
        and write it into ``outfile``.

        This implementation calculates where it should draw each token on the pixmap,
        then calculates the required pixmap size and draws the items.
        """
...
class GifImageFormatter(ImageFormatter):
    """Create a GIF image from source code. a pixmap from the source code. This. uses
    the Python Imaging Library to. generate.
...
class JpgImageFormatter(ImageFormatter):
    """Create a JPEG image from source code. generate a pixmap from the source code.
...
class BmpImageFormatter(ImageFormatter):
    """Create a bitmap image from source code. generate a pixmap from the source code.
    This uses the Python Imaging Library to.
