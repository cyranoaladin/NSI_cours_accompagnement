...
class RtfFormatter(Formatter):
    """Format tokens as RTF markup. automatically outputs full RTF Paste into documents
    with color information and other stuff. Perfect for Copy and This formatter useful
    Microsoft(R) Word(R) documents.
    ...
    def _split_tokens_on_newlines(self, tokensource):
        """Split tokens containing newline characters into multiple token each
        representing a line of the input file.

        Needed for numbering lines of e.g. multiline comments.
        """
    ...
    def _create_color_mapping(self):
        """Create a mapping of style hex colors to index/offset in the RTF color
        table."""
