...
class BashSessionLexer(ShellSessionBaseLexer):
    """Lexer for Bash shell sessions, i.e. command lines, including a prompt,
...
class MSDOSSessionLexer(ShellSessionBaseLexer):
    """Lexer for MS DOS shell sessions, i.e. command lines, including a prompt,
    interspersed with output."""
...
class TcshSessionLexer(ShellSessionBaseLexer):
    """Lexer for Tcsh sessions, i.e. command lines, including a prompt, interspersed
    with output."""
...
class PowerShellSessionLexer(ShellSessionBaseLexer):
    """Lexer for PowerShell sessions, i.e. command lines, including a prompt,
    interspersed with output."""
