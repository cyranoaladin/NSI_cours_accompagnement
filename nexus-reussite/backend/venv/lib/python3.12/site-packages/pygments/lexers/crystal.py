...
class CrystalLexer(ExtendedRegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                words(
                    """Abstract asm begin break case do else elsif end ensure extend if
                    in include next of private protected require rescue return select
                    self super then unless until when while with yield."""
                                                                          .split(),
                    suffix=r"\b",
                ),
                Keyword,
