...
class ErbLexer(Lexer):
    ...
    def get_tokens_unprocessed(self, text):
        """Since ERB doesn't allow "<%" and other tags inside of ruby blocks we have to
        use a split approach here that fails for that too."""
...
class SmartyLexer(RegexLexer):
    ...
    Just highlights smarty code between the preprocessor directives, other data is left
    untouched by the lexer.
    """
...
class VelocityLexer(RegexLexer):
    ...
    Just highlights velocity directives and variable references, other data is left
    untouched by the lexer.
    """
...
class VelocityHtmlLexer(DelegatingLexer):
    """Subclass of the `VelocityLexer` that highlights unlexed data with the
    `HtmlLexer`."""
...
class MyghtyLexer(RegexLexer):
    """Generic myghty templates lexer.

    Code that isn't Myghty
    ...
    tokens = {
        "root": [
            ...
            (
                ...
                (?<=\n)(?=[%#]) |  # an eval or comment line (?=</?[%&]) |      # a
                substitution or block or.
...
class MyghtyHtmlLexer(DelegatingLexer):
    """Subclass of the `MyghtyLexer` that highlights unlexed data with the
    `HtmlLexer`."""
...
class MasonLexer(RegexLexer):
    """Generic mason templates lexer.

    Stolen from Myghty lexer. Code that isn't Mason markup is HTML.
    """
...
class MakoLexer(RegexLexer):
    """Generic mako templates lexer.

    Code that isn't Mako
    markup is yielded as `Token.Other`.
    """
    ...
    tokens = {
        "root": [
            ...
            (
                ...
                multiline comment (?=</?%) |          # a python block # call start or
                end (?=\$\{) |          # a substitution.
...
class MakoJavascriptLexer(DelegatingLexer):
    """Subclass of the `MakoLexer` that highlights unlexed data with the
    `JavascriptLexer`."""
...
class CheetahLexer(RegexLexer):
    """Generic cheetah templates lexer. templates`_ which use the same syntax. markup is
    yielded as `Token.Other`.  This works for Code that isn't Cheetah `spitfire also.
    ...
    tokens = {
        "root": [
            ...
            (
                r"""(?sx) (.+?)               # anything, followed by: (?:
                (?=\#[#a-zA-Z]*) | # an eval comment (?=\$[a-zA-Z_{]) | # a
                substitution.
...
class CheetahHtmlLexer(DelegatingLexer):
    """Subclass of the `CheetahLexer` that highlights unlexed data with the
    `HtmlLexer`."""
...
class XmlErbLexer(DelegatingLexer):
    """Subclass of `ErbLexer` which highlights data outside preprocessor directives with
    the `XmlLexer`."""
...
class JspRootLexer(RegexLexer):
    ...
    JSP tags. Yields `Token.Other` for area outside of.
        .. versionadded:: 0.7
    """
...
class TeaTemplateRootLexer(RegexLexer):
    """Base for the `TeaTemplateLexer`. for area. outside of. code blocks. Yields
    `Token.Other`
...
class TwigLexer(RegexLexer):
    ...
    It just highlights Twig code between the preprocessor directives, other data is left
    untouched by the lexer.
    """
