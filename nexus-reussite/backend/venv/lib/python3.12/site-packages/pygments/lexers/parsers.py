...
class RagelEmbeddedLexer(RegexLexer):
    ...
    This will only highlight Ragel statements. If you want host language highlighting
    then call the language-specific Ragel lexer.
    """
...
class AntlrLexer(RegexLexer):
    ...
    Should not be called directly, instead use DelegatingLexer for your target language.
    """
