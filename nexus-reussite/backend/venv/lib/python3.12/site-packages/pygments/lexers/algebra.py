...
class GAPLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"\(|\)|\[|\]|\{|\}", Punctuation),
            (
                r"""(?x)\b(?: if|then|elif|else|fi| for|while|do|od| repeat|until|
                break|continue| function|local|return|end| rec| quit|QUIT|
                IsBound|Unbind| TryNextMethod|
            ...
            (
                ...
                true|false|fail|infinity )\b
                """
                Name.Constant,
            ),
            (
                r"""(?x)\b(?: (Declare|Install)([A-Z][A-Za-z]+)|

                BindGlobal|BIND_GLOBAL )\b
                """
                    .Builtin,
            ),
            (r"\.|,|:=|;|=|\+|-|\*|/|\^|>|<", Operator),
...
class GAPConsoleLexer(Lexer):
    """For GAP console sessions.

    Modeled after JuliaConsoleLexer.
    """
...
class MuPADLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"\(|\)|\[|\]|\{|\}", Punctuation),
            (
                r"""(?x)\b(?: next|break|end|
                axiom|end_axiom|category|end_category|domain|end_domain|inherits|
                if|%if|then|elif|else|end_if| case|of|do|otherwise|end_case|
                while|end_while| repeat|until|end_repeat|
                for|from|to|downto|step|end_for| proc|local|option|save|begin|end_proc|
            ...
            (
                r"""(?x)\b(?: PI|EULER|E|CATALAN| NIL|FAIL|undefined|infinity|

                TRUE|FALSE|UNKNOWN )\b
                """
                     Constant,
            ),
            ...
            (r"\.|,|:|;|=|\+|-|\*|/|\^|@|>|<|\$|\||!|\'|%|~=", Operator),
            (
                r"""(?x)\b(?: and|or|not|xor| assuming| div|mod|

                union|minus|intersect|in|subset )\b
                """
                        .Word,
            ),
