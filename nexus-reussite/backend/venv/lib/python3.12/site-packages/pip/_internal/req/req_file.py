...
def parse_requirements(
    ...
    :param constraint: If true, parsing a constraint file rather than requirements file.
    """
...
def handle_line(
    ...
    """Handle a single parsed requirements line; This can result in creating/yielding
...
def break_args_options(line: str) -> tuple[str, str]:
    ...
    We only want to shlex (and then optparse) the options, not the args.  args can
    contain markers which are corrupted by shlex.
    """
    tokens = line.split(" ")
    args = []
    options = tokens[:]
