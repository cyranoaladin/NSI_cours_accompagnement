...
class BaseDistribution(Protocol):
    ...
    def editable_project_location(self) -> str | None:
        ...
        This is the directory where pyproject.toml or setup.py is located. None if the
        distribution is not installed in editable mode.
        """
    ...
    def installed_as_egg(self) -> bool:
        ...
        This usually indicates the distribution was installed by (older versions of)
        easy_install.
        """
    ...
    def metadata(self) -> email.message.Message:
        ...
        :raises NoneMetadataError: If the metadata file is available, but does not
    ...
    def requires_python(self) -> SpecifierSet:
        ...
        If the key does not exist or contains an invalid value, an empty SpecifierSet
        should be returned.
        """
    ...
    def iter_dependencies(self, extras: Collection[str] = ()) -> Iterable[Requirement]:
        ...
        For modern .dist-info distributions, this is the collection of "Requires-Dist:"
        entries in distribution metadata.
        """
        raise NotImplementedError()
...
class BaseEnvironment:
    ...
    def get_distribution(self, name: str) -> BaseDistribution | None:
        ...
        The name may not be normalized. The implementation must canonicalize it for
        lookup.
        """
        raise NotImplementedError()
