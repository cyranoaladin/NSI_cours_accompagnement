...
def search_packages_info(query: list[str]) -> Generator[_PackageInfo, None, None]:
    ...
    Print distribution name, version, location, and installed files. Installed files
    requires a pip generated 'installed-files.txt' in the distributions '.egg-info'
    directory.
    """
