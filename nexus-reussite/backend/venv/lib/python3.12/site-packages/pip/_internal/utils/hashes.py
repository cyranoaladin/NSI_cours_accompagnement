...
class Hashes:
    """A wrapper that builds multiple hashes at once and checks them against known-good
    values."""
...
class MissingHashes(Hashes):
    ...
    It computes the actual hash of the requirement and raises a HashMissing exception
