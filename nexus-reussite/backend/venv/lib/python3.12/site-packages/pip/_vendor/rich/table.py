...
class Column:
    ...
    """Str: How to justify text within the column ("left", "center", "right", or
    "full")"""
    ...
    """Optional[int]: Width of the column, or ``None`` (default) to auto calculate
    width."""
    ...
    """Optional[int]: Ratio to use when calculating column width, or ``None`` (default)
    to adapt to column contents."""
...
class Table(JupyterMixin):
    ...
    def _calculate_column_widths(
        ...
        """Calculate the widths of each column, including padding, not including
        borders."""
        max_width = options.max_width
        columns = self.columns
        width_ranges = [
