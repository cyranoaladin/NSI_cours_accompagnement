...
class CacheControlAdapter(HTTPAdapter):
    ...
    def send(
        ...
        Use the request information to see if it exists in the cache and cache the
        response if we need to and can.
        """
    ...
    def build_response(  # type: ignore[override]
        ...
        This will end up calling send and returning a potentially cached response
        """
        cacheable = cacheable_methods or self.cacheable_methods
