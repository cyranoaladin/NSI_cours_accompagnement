...
class ScriptMaker(object):
    ...
    def _build_shebang(self, executable, post_interp):
        """Build a shebang line. shebang line the shebang. which is not too long or
        contains spaces) use a simple formulation for In the simple case (on Windows, or
        a Otherwise, use /bin/sh as the executable, with a contrived shebang which
        allows the script to run either under Python or sh, using suitable quoting.
        Thanks to Harald Nordgren for his input.
    ...
    def make(self, specification, options=None):
        ...
        :param specification: The specification, which is either a valid export entry
            specification (to make a script from a callable) or a filename (to make a
            script by copying from a source location).
