...
def _is_namedtuple(obj: Any) -> bool:
    """Checks if an object is most likely a namedtuple. namedtuple, but It is possible
    there is only a minuscule to craft an object that this check and isn't a passes
    chance of this happening unintentionally.
