...
class Text(JupyterMixin):
    ...
    def styled(
        ...
        *,
        ...
        """Construct a Text instance with a pre-applied styled. applied in this way
        won't be used. to pad the text when it. is justified. A style.
    ...
    def assemble(
        ...
        *parts: Union[str, "Text", Tuple[str, StyleType]],
        ...
        """Construct a text instance by combining a sequence of strings with optional
        styles. The positional arguments should be either strings, or a tuple of string
        + style.
    ...
    def blank_copy(self, plain: str = "") -> "Text":
        """Return a new Text instance with copied metadata (but not the string or
        spans)."""
        copy_self = Text(
            plain,
            style=self.style,
    ...
    def extend_style(self, spaces: int) -> None:
        """Extend the Text given number of spaces where the spaces have the same style
    ...
    def highlight_regex(
        ...
        *,
        ...
        """Highlight text with a regular expression, where group names are translated to
        styles.
    ...
    def append_text(self, text: "Text") -> "Text":
        """Append another Text instance. for Text. This method is more. performant that
        Text.append, but. only works.
    ...
    def append_tokens(
        ...
        Style may be a Style instance or a str style definition.
                Args:
