...
class Task:
    ...
    def remaining(self) -> Optional[float]:
        """Optional[float]: Get the number of steps remaining, if a non-None total was
        set."""
    ...
    def elapsed(self) -> Optional[float]:
        """Optional[float]: Time elapsed since task was started, or ``None`` if the task
        hasn't started."""
    ...
    def percentage(self) -> float:
        ...
        If a None total was set, returns 0
        """
        if not self.total:
            return 0.0
