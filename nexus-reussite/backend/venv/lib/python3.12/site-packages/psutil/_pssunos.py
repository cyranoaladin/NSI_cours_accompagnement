...
def net_connections(kind, _pid=-1):
    ...
    process only). Only INET sockets are returned (UNIX are not).
    """
...
def wrap_exceptions(fun):
    """Call callable into a try/except clause and translate ENOENT, EACCES and EPERM in
    NoSuchProcess or AccessDenied exceptions."""
