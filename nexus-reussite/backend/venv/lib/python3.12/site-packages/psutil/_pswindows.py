...
def getloadavg():
    ...
    5, and 15 minutes respectively as a tuple."""
...
def net_connections(kind, _pid=-1):
    ...
    If pid == -1 return system-wide connections (as opposed to connections opened by one
    process only).
    """
...
class WindowsService:  # noqa: PLW1641
    ...
    def _wrap_exceptions(self):
        """Ctx manager which translates bare OSError and WindowsError exceptions into
    ...
    def name(self):
        ...
        This string is how a service is referenced and can be passed to
        win_service_get() to get a new WindowsService instance.
        """
        return self._name
    ...
    def display_name(self):
        ...
        The value is cached when this class is instantiated.
        """
    ...
    def pid(self):
        ...
        This can be passed to Process class to control the service's process.
        """
...
class Process:
    ...
    def name(self):
        """Return process name, which on Windows is always the final part of the
        executable."""
