...
class RateLimiter(metaclass=ABCMeta):
    ...
    def test(self, item: RateLimitItem, *identifiers: str, cost: int = 1) -> bool:
        ...
        :param item: The rate limit item
        :param identifiers: variable list of strings to uniquely identify this instance
            of the limit
...
class SlidingWindowCounterRateLimiter(RateLimiter):
    ...
    def _weighted_count(
        ...
        """Return the approximated by weighting the previous window count and adding the
