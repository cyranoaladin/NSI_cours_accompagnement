...
class MovingWindowSupport(ABC):
    """Abstract base class for storages that support the :ref:`strategies:moving window`
    strategy."""
...
class SlidingWindowCounterSupport(ABC):
    """Abstract base class for storages that support the :ref:`strategies:sliding window
    counter` strategy."""
    ...
    def acquire_sliding_window_entry(
        ...
        """Acquire an entry if the weighted count of the current and previous windows is
    ...
    def clear_sliding_window(self, key: str, expiry: int) -> None:
        ...
        :param key: the key to clear rate limits for
        :param expiry: the rate limit expiry, needed to compute the key in some
            implemenations
        """
        ...
...
class TimestampedSlidingWindow:
    """Helper class for storage that support the sliding window counter, with timestamp
    based keys."""
