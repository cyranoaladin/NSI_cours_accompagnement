...
This is set as a separate rule to provide an opportunity for plugins to run text
replacements after text join, but before escape join.
...
def text_join(state: StateCore) -> None:
    """Join raw text for escape sequences (`text_special`) tokens with the rest of the
    text."""
