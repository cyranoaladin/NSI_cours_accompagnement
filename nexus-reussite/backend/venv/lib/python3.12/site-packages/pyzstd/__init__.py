try:
    ...
    from ._c import ZstdFileReader as _ZstdFileReader
    from ._c import ZstdFileWriter as _ZstdFileWriter
    from ._c import (
        _finalize_dict,
        _train_dict,
        _ZSTD_CStreamSizes,
    ...
    from ._c import compress_stream as _compress_stream
    from ._c import (
        compressionLevel_values,
        decompress,
    )
    from ._c import decompress_stream as _decompress_stream
    from ._c import (
        get_frame_info,
        get_frame_size,
        zstd_version,
    ...
    try:
        ...
        from ._cffi import ZstdFileReader as _ZstdFileReader
        from ._cffi import ZstdFileWriter as _ZstdFileWriter
        from ._cffi import (
            _finalize_dict,
            _train_dict,
            _ZSTD_CStreamSizes,
        ...
        from ._cffi import compress_stream as _compress_stream
        from ._cffi import (
            compressionLevel_values,
            decompress,
        )
        from ._cffi import decompress_stream as _decompress_stream
        from ._cffi import (
            get_frame_info,
            get_frame_size,
            zstd_version,
