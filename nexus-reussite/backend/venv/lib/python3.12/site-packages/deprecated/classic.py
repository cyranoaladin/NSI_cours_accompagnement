...
class ClassicAdapter(wrapt.AdapterFactory):
    ...
    def get_deprecated_msg(self, wrapped, instance):
        ...
        :param instance: The object to which the wrapped function was bound when it was
            called.
...
def deprecated(*args, **kwargs):
    """This is a decorator which can be used to mark functions as deprecated. a warning
    being emitted when the function is used. It will. result in.
