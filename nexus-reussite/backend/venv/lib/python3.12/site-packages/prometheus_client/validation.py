...
def _validate_metric_name(name: str) -> None:
    ...
    This check uses the global legacy validation setting to determine the validation
    scheme.
    """
    if not name:
...
def _is_valid_legacy_metric_name(name: str) -> bool:
    """Returns true if the provided metric name conforms to the legacy validation
    scheme."""
...
def _is_valid_legacy_labelname(l: str) -> bool:
    """Returns true if the provided label name conforms to the legacy validation
    scheme."""
