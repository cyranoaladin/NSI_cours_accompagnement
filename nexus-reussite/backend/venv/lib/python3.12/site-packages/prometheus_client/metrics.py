...
class MetricWrapperBase(Collector):
    ...
    def _metric_init(self):  # pragma: no cover
        """Initialize the metric object as a child, i.e. when it has labels (if any)
        set.
...
class Counter(MetricWrapperBase):
    ...
    def reset(self) -> None:
        ...
        Use this when a logical process restarts without restarting the actual python
        process.
        """
        self._value.set(0)
        self._created = time.time()
    ...
    def count_exceptions(
        ...
        when an exception of the given type is raised up out of the code.
        """
        self._raise_if_not_observable()
...
class Gauge(MetricWrapperBase):
    ...
    def track_inprogress(self) -> InprogressTracker:
        ...
        Can be used as a function decorator or context manager. Increments the gauge
        when the code is entered, and decrements when it is exited.
        """
        self._raise_if_not_observable()
    ...
    def set_function(self, f: Callable[[], float]) -> None:
        ...
        The function must return a float, and may be called from multiple threads. All
        other methods of the Gauge become NOOPs.
        """
        self._raise_if_not_observable()
...
class Summary(MetricWrapperBase):
    ...
    def observe(self, amount: float) -> None:
        ...
        The amount is usually positive or zero. Negative values are accepted but prevent
        current versions of Prometheus from properly detecting counter resets in the sum
        of observations. See
