...
class TestTeacher:
    ...
    def test_teacher_validation_speciality_required(self, test_db):  # pylint: disable=unused-argument
    ...
    def test_teacher_validation_experience_years_positive(self, test_db):  # pylint: disable=unused-argument
        """Test de validation - années d'expérience positives"""
        # Arrange & Act & Assert
        with pytest.raises(ValueError, match="Les années d'expérience doivent être positives"):
            Teacher(  # pylint: disable=unused-variable
                speciality='Mathématiques',
                experience_years=-1
            )

    def test_teacher_validation_experience_years_reasonable(self, test_db):  # pylint: disable=unused-argument
        """Test de validation - années d'expérience raisonnables"""
        # Arrange & Act & Assert
        with pytest.raises(ValueError, match="Les années d'expérience ne peuvent pas dépasser 50"):
            Teacher(  # pylint: disable=unused-variable
                speciality='Mathématiques',
                experience_years=51
            )

    def test_find_teachers_by_speciality(self, test_db, sample_user):  # pylint: disable=unused-argument
    ...
    def test_teacher_update_speciality(self, test_db, sample_user):  # pylint: disable=unused-argument
        ...
        # Act
        teacher.speciality = 'Géologie'  # pylint: disable=attribute-defined-outside-init
        test_db.session.commit()
    ...
    def test_teacher_increment_experience(self, test_db, sample_user):  # pylint: disable=unused-argument
    ...
    def test_teacher_delete_cascade(self, test_db, sample_user):  # pylint: disable=unused-argument
    ...
    def test_teacher_query_by_experience_range(self, test_db, sample_user):  # pylint: disable=unused-argument
    ...
    def test_teacher_with_certification(self, test_db, sample_user):  # pylint: disable=unused-argument
    ...
    def test_teacher_without_certification(self, test_db, sample_user):  # pylint: disable=unused-argument
