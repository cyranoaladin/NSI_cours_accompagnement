...
class TestExerciseModel:
    ...
    def test_calculate_completion_time(self):
        ...
        # Arrange
        exercise = Exercise(
            title="Test", subject="Mathématiques", difficulty=3, points=15
        )
...
class TestExerciseCompletion:
    ...
    def test_is_passed(self):
        ...
        # Arrange
        passing_completion = ExerciseCompletion(student_id=1, exercise_id=1, score=75.0)
        failing_completion = ExerciseCompletion(student_id=1, exercise_id=1, score=45.0)
    ...
    def test_get_grade_letter(self):
        ...
        # Act & Assert
        assert (
            ExerciseCompletion(student_id=1, exercise_id=1, score=95).get_grade_letter()
            == "A"
        )
        assert (
            ExerciseCompletion(student_id=1, exercise_id=1, score=85).get_grade_letter()
            == "B"
        )
        assert (
            ExerciseCompletion(student_id=1, exercise_id=1, score=75).get_grade_letter()
            == "C"
        )
        assert (
            ExerciseCompletion(student_id=1, exercise_id=1, score=65).get_grade_letter()
            == "D"
        )
        assert (
            ExerciseCompletion(student_id=1, exercise_id=1, score=45).get_grade_letter()
            == "F"
        )
