...
class TestNotificationService:
    ...
    def test_get_notification_history(self):
        ...
        with patch('src.services.notification_service.get_notification_logs') as mock_get_logs:
            mock_logs = [
                {'id': 1, 'type': 'email', 'status': 'sent', 'timestamp': '2025-01-01'},
                {'id': 2, 'type': 'push', 'status': 'failed', 'timestamp': '2025-01-02'}
            ]
    ...
    def test_notification_preferences(self):
        ...
        with patch('src.services.notification_service.get_user_preferences') as mock_get_prefs:
    ...
    def test_notification_analytics(self):
        ...
        with patch('src.services.notification_service.get_analytics_data') as mock_analytics:
