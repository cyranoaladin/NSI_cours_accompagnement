...
class TestStudentAPIIntegration:
    ...
    def test_student_enrollment_and_progress_flow(self, client, test_student, auth_headers):
        ...
        response = client.post(f'/api/students/{test_student.id}/enroll',
                             data=json.dumps(course_data),
                             content_type='application/json',
                             headers=auth_headers)
        assert response.status_code == 201
        enrollment_data = json.loads(response.data)
        _ = enrollment_data['enrollment_id']  # enrollment_id stored but not used in this test
        ...
        response = client.post(f'/api/students/{test_student.id}/progress',
        ...
        response = client.get(f'/api/students/{test_student.id}/stats',
                            headers=auth_headers)
        assert response.status_code == 200
        ...
        response = client.get(f'/api/students/{test_student.id}/report',
                            headers=auth_headers)
        assert response.status_code == 200
...
class TestARIAIntegration:
    ...
    def test_aria_conversation_flow(
        ...
        response = client.post('/api/aria/conversations',
        ...
        response = client.post('/api/aria/chat',
        ...
        response = client.get(f'/api/aria/conversations/{conversation_id}',
                            headers=auth_headers)
        assert response.status_code == 200
        ...
        response = client.post(f'/api/aria/conversations/{conversation_id}/evaluate',
...
class TestAdminAPIIntegration:
    ...
    def test_admin_user_management_flow(
        ...
        update_data = {
            'name': 'Updated Admin Created User',
            'is_active': False
        }
        response = client.put(f'/api/admin/users/{created_user_id}',
                            data=json.dumps(update_data),
                            content_type='application/json',
                            headers=admin_headers)
        assert response.status_code == 200
        ...
        response = client.delete(f'/api/admin/users/{created_user_id}',
                               headers=admin_headers)
        assert response.status_code == 204
...
class TestEndToEndWorkflow:
    ...
    def test_complete_student_learning_journey(self, client):
        ...
        response = client.post(f'/api/students/{student_id}/progress',
                             data=json.dumps(progress_data),
                             content_type='application/json',
                             headers=headers)
        assert response.status_code == 201
        ...
        response = client.get(f'/api/students/{student_id}/stats',
                            headers=headers)
        assert response.status_code == 200
        stats_data = json.loads(response.data)
        ...
        response = client.get(f'/api/students/{student_id}/report',
                            headers=headers)
        assert response.status_code == 200
        report_data = json.loads(response.data)
        assert 'overall_progress' in report_data
